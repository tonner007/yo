...
import { maxRedeem, prepareRedeemWithApproval, quotePreviewWithdraw, waitForRedeemReceipt, YO_GATEWAY_ADDRESS } from '@yo-protocol/core';
...
export async function executeWithdraw({ network = 'base', amount, userAddress, walletClient, switchNetwork }) {
  ...
  const txs = await prepareRedeemWithApproval(publicClient, {
